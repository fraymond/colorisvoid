export const NEWS_DIGEST_BASE_PROMPT_VERSION = "2026-03-21-v2";
export const NEWS_DIGEST_FIXED_HASHTAGS = ["#AI", "#AI新闻", "#献哥AI报道"];
...
{
  "title": "一句适合当天新闻稿的标题",
  "hashtags": ["#AI", "#AI新闻", "#献哥AI报道", "#Copilot", "#大模型效率"],
  "script": "完整口播稿"
}

额外要求：
- hashtags 里必须固定包含 #AI、#AI新闻、#献哥AI报道。
